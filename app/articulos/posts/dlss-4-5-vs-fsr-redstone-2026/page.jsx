  ...
  return (
    ...
    >
      ...
      <div className="article-content">
        ...
        <p>
          Por eso preguntar simplemente <b>“¿DLSS o FSR da más FPS?”</b> ya no
          es suficiente.
        </p>
        ...
        <h2>
          Tener una RTX no significa tener todas las funciones de DLSS 4.5
        </h2>

        <p>
          Una de las confusiones más habituales con DLSS es pensar que todas las
          tarjetas GeForce RTX reciben exactamente las mismas funciones. No es
          así. Una RTX 2060 puede utilizar tecnologías modernas de reconstrucción
          de imagen, pero no tiene las mismas capacidades de generación de
          fotogramas que una RTX 4060 o una RTX 5070.
        </p>
        ...
        <p>
          Las series RTX 20 y RTX 30 pueden utilizar{" "}
          <b>DLSS Super Resolution</b>, <b>DLAA</b> y{" "}
          <b>Ray Reconstruction</b> en los juegos compatibles. Esto significa
          que incluso una RTX de varias generaciones atrás todavía puede
        ...
        <p>
          ...
          introducidos con DLSS 4.5 pueden tener un impacto de rendimiento mayor
          en las RTX 20 y RTX 30 porque estas generaciones no cuentan con soporte
        ...
        <p>
          Pero la serie RTX 40 no dispone del <b>Multi Frame Generation</b>{" "}
          completo de las RTX 50. Es una diferencia que conviene tener clara,
          porque Frame Generation y Multi Frame Generation no son exactamente lo
          mismo.
        </p>
        ...
        <p>
          La serie RTX 50 es actualmente la que tiene acceso al conjunto más
          amplio de funciones de DLSS. Además de Super Resolution y Frame
          Generation, puede utilizar <b>Multi Frame Generation</b> y{" "}
          <b>Dynamic Multi Frame Generation</b>.
        </p>

        <p>
          Con DLSS 4.5, NVIDIA permite alcanzar un modo de hasta <b>6X</b> en
          juegos compatibles. En ese modo pueden generarse hasta cinco
          fotogramas adicionales por cada fotograma renderizado
          tradicionalmente.
        </p>
        ...
        <p>
          ...
          la misma respuesta que tendría renderizando 200 FPS de forma
          tradicional. Más adelante veremos por qué la latencia es una parte
          fundamental de esta comparación.
        </p>
        ...
        <div style={{ overflowX: "auto", margin: "8px 0 12px" }}>
          ...
          >
            <thead>
              <tr>
                <th style={{ textAlign: "left", padding: 10 }}>Función</th>
